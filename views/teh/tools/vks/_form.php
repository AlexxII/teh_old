...
<div class="row">
  <div class="hide-middle col-lg-2 col-md-1"></div>
  <div class="col-lg-6 col-md-8">
    <h1><?= Html::encode($this->title) ?></h1>

    <div class="customer-form">
      <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data', 'id' => 'dynamic-form' ]]); ?>
      <?= $form->field($modelComplex, 'category_id')->dropDownList($modelComplex->categoryListEx, ['prompt' => ['text' => 'Выберите', 'options' => ['value' => 'none', 'disabled' => 'true', 'selected' => 'true']]])->hint('Выберите из списка', ['class' => ' w3-label-under']); ?>
      <div class="row">
        <div class="col-sm-6">
          <?= $form->field($modelComplex, 'complex_title')->textInput()->hint('Например: Polycom VSX 3000', ['class' => ' w3-label-under']); ?>
        </div>
        <div class="col-sm-6">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <?= $form->field($modelComplex, 'soft_version')->textInput()->hint('Например: Release-2.6.1_ne-5159', ['class' => ' w3-label-under']); ?>
        </div>
      </div>
